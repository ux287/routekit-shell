...
export interface GuardrailEvent {
  id: string | null;
  type: 'chain.violation' | 'hook.guardrail_bump' | string;
  timestamp: string | null;
  projectId: string | null;
  // Execution-path context. chain.violation: blockedTool, flowType, state, violationKind,
  // expectedTools. hook.guardrail_bump: hookName, blockedTool, redirectAgent, reason, problemId.
  payload: Record<string, unknown>;
}
