 ...
 *             baselineAbsentPaths: string[], baselineTestPaths: string[]|null }
 *          | { proceed: false, refusal: object }}
 */
export function runPreApplyBaseline({ projectRoot, storyTestFiles, runDir, runTests }) {
  let testPaths = null;
  ...
  return {
    ...
    refusal: {
      ...
      hint: 'Tests were failing BEFORE any change was applied (pre-apply baseline): nothing was applied and no branch was created. '
        ...
        + (testsFailedLog ? `; see ${testsFailedLog}.` : '.'),
    },
  };
}
