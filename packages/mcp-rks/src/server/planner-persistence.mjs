  ...
  if (normalizedProblem) {
    try {
      ...
      if (planStatus === "note_only" || planStatus === "quality_failed") {
        ...
        try {
          const _current = readNote(notesDir, normalizedProblem);
          if (["planned", "executing", "executed"].includes(_current?.phase)) {
            updateField(notesDir, normalizedProblem, "phase", "arch-approved");
          }
