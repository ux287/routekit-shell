...
function buildSummary(events, startDate, endDate) {
  ...
  for (const ev of events) {
    ...
    if (agentMatch) {
      ...
      if (!agents[agentName]) {
        agents[agentName] = { invocations: 0, completed: 0, failed: 0, toolCalls: 0, failedToolCalls: 0, totalDurationMs: 0, escalations: 0 };
      }
  ...
  return {
    ...
    agents: agentSummary,
    totals: {
      agentInvocations: Object.values(agents).reduce((s, a) => s + a.invocations, 0),
