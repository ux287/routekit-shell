...
// Cost policy (backlog.feat.haiku-primary-agent-defaults): agents default to Haiku 4.5
// (~1/3 the cost of Sonnet) with a Sonnet fallback — the runner's same-model retry +
// model escalation net catches hard failures. EXCEPTION: `planner` stays Sonnet-primary
// because plan-quality drift is silent (not a hard failure escalation can catch); it will
// move to Haiku once the self-escalation-signal story lands.
const DEFAULTS = {
  'product-owner': { model: 'claude-haiku-4-5-20251001', fallbackModel: 'claude-sonnet-4-6', maxTurns: 5, timeoutMs: 60_000 },
  ...
  'ship': { model: 'claude-haiku-4-5-20251001', fallbackModel: 'claude-sonnet-4-6', maxTurns: 8, timeoutMs: 120_000 },
  'cycle-complete': { model: 'claude-haiku-4-5-20251001', maxTurns: 7, timeoutMs: 90_000 },
  'story': { model: 'claude-haiku-4-5-20251001', fallbackModel: 'claude-sonnet-4-6', maxTurns: 7, timeoutMs: 90_000 },
  'delivery': { model: 'claude-haiku-4-5-20251001', fallbackModel: 'claude-sonnet-4-6', maxTurns: 15, timeoutMs: 300_000 },
  'recovery': { model: 'claude-haiku-4-5-20251001', fallbackModel: 'claude-sonnet-4-6', maxTurns: 10, timeoutMs: 120_000 },
  // planner stays Sonnet-primary (see note above); the old sonnet→sonnet no-op fallback is removed.
  'planner': { model: 'claude-sonnet-4-6', maxTurns: 10, timeoutMs: 120_000 },
  'lifecycle': { model: 'claude-haiku-4-5-20251001', fallbackModel: 'claude-sonnet-4-6', maxTurns: 12, timeoutMs: 300_000 },
};

const GLOBAL_DEFAULTS = { model: 'claude-haiku-4-5-20251001', fallbackModel: 'claude-sonnet-4-6', maxTurns: 10, timeoutMs: 120_000 };
