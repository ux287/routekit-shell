...
import { classifyMarkerFailure, decideToolOutcome, toolPayloadFromResponse, TOOL_FAILED } from "./server/failure-classification.mjs";
        ...
        try {
          ...
          if (marker && marker.projectId === input.projectId) {
            ...
            if (marker.done === true && marker.ok === true) {
              ...
              const { failureClass, message: failureClassMessage } = classifyMarkerFailure(marker);
