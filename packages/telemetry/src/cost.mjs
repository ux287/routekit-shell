...
// Model pricing per 1M tokens (USD). Exported as the single pricing source consumed by
// cost-report.mjs's byModel breakdown (backlog.feat.cost-report-cache-and-model-rollup) — do NOT
// introduce a divergent per-model rate table elsewhere.
