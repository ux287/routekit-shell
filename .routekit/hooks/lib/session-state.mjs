...
// indefinitely. Enforced by a direct timestamp comparison against this constant
// (NOT the disabled generic isExpired). Exported for read-classification.mjs and
// the ledger tests.
