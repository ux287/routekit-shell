---
id: ak9awma1i9oc3mdcpr6vova
title: How to maintain the release-smoke workflow and its fixture vault
desc: >-
  Operator's guide for the post-release smoke verification job — what it covers,
  when it fires, and how to update fixtures when the content_type taxonomy
  evolves.
