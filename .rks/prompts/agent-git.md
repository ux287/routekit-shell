...
5. git_stash — pop, list, apply or drop an EXISTING stash. You cannot CREATE one: a stash made here has no restore path, so it would be abandoned. If a dirty tree blocks you, commit with git_commit or report the refusal — do not work around it.
