---
id: how-to.write-backlog-stories
title: Write Backlog Stories
desc: Guide to writing well-structured backlog stories for RKS planning and execution
---
...
| `phase` | Current lifecycle phase (see how-to.story-lifecycle) |
...
Both forms are read. The comment form is **canonical** for the directive: it is what the
Target Files section uses and what every validator reads. The content fence is bound from
either form, so the heading shown above and the comment form are interchangeable for
declaring the content of a new file.
