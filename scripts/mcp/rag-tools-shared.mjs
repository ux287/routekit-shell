...
// scripts (@routekit/rag/init, @routekit/rag/embed) — deliberately NOT the governed runRagInit/runRagEmbed
// wrappers in packages/rag/src/tools.mjs, which drop the client `db` and add embed-lock
...
// backward-compatibly.
import { z } from "zod";
import { init as ragInit } from "@routekit/rag/init";
import { embed as ragEmbed } from "@routekit/rag/embed";
import { getDefaultRagConfig } from "@routekit/rag/utils";
