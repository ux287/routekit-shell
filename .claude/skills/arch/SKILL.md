...
ARCH reviews one or more stories holistically before any Build is launched. It reads each story note and its target files, applies an 11-item mechanical checklist, and returns a binary verdict. ARCH runs for every story — no skip conditions.
