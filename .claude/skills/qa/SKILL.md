...
Next is the ARCH gate, not Build: after every QA in the batch has returned `ready`, invoke
/arch ONCE with the full storyId list. Build is not launched until ARCH returns `approved`.
