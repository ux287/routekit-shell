...
const NON_OPEN_FLOW_BASELINE = {
  "story": {
    ...
    "refining": ["dendron_create_note", "dendron_edit_note", "dendron_read_note", "dendron_update_field", "rks_agent_external_research", "rks_agent_git", "rks_agent_research", "rks_analyze", "rks_exhaustive_search", "rks_plan", "rks_plan_ready", "rks_preflight", "rks_project_get", "rks_refine", "rks_refine_apply"],
    "decompose-gated": ["rks_plan", "rks_project_get", "rks_refine_apply"],
    "planning": ["rks_agent_git", "rks_plan_review", "rks_project_get"],
    "planned": ["rks_agent_external_research", "rks_agent_git", "rks_agent_research", "rks_exec", "rks_plan", "rks_plan_review", "rks_project_get", "rks_refine"],
    ...
    "executed": ["rks_agent_git", "rks_project_get", "rks_ship", "rks_story_ship"],
