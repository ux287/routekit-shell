...
function makeFixtureRepo() {
  ...
  const files = [
    ...
    "scripts/mcp/rag-server.mjs", // a scripts/ subtree file so the "scripts/" prefix test still resolves
    "README.md",
    "LICENSE",
...
describe("publish include-allowlist glob expansion (functional, offline)", () => {
  ...
  it("AC2: directory prefixes include their full subtree (no regression)", () => {
    ...
    expect(files).toContain("packages/rag/src/init.mjs");
    expect(files).toContain("scripts/mcp/rag-server.mjs");
