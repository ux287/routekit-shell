...
describe.skipIf(!liveRksPublic)("rks-public profile — functional selection/omission against a fixture repo", () => {
  ...
  beforeAll(() => {
    ...
    const files = [
      ...
      "packages/presentations/src/decks/what-is-rks.deck.tsx",
      "packages/presentations/src/registry.ts",
  ...
  it("the public dashboard-as-tool ships, but its marketing decks + all content packages do NOT", () => {
    ...
    expect(sel).not.toContain("packages/presentations/src/decks/what-is-rks.deck.tsx");
    expect(sel).not.toContain("packages/presentations/src/registry.ts");
