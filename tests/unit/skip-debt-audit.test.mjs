...
const ALLOWLIST = [
  ...
  // PAID DOWN by backlog.fix.clean-machine-honesty: the skip is gone. Those two tests were the only
  // BEHAVIORAL coverage in that file — everything else was a source-text grep of server.mjs, which
  // stayed green the whole time the version field was reporting the wrong build. The greps are
  // deleted and the behavioral tests now run against the real exports.
  ...
  { file: 'tests/unit/ci-skips-docs-and-config-commits.test.mjs', line: 308, reason: 'OPERATIONAL: A2 docs/config commits skip CI — verified by human post-merge' },
  { file: 'tests/unit/release-bump-skip-ci.test.mjs', line: 185, reason: 'OPERATIONAL: A1 bump-push to staging skips CI — verified by human post-merge' },
  { file: 'tests/unit/release-bump-skip-ci.test.mjs', line: 192, reason: 'OPERATIONAL: A1 main ff-merge skips CI — verified by human post-merge' },
  ...
  // Line numbers shifted +1 when `import { resolveHookPath }` was added to make this file
  // .bak-tolerant (off-rail abort-path work); the six it.skip calls moved 36/43/50/56/62/68 → 37/44/51/57/63/69.
  { file: 'tests/unit/redirect-github-tools-to-governor.test.mjs', line: 37, reason: 'B4-followup: pre-existing redirect-github-tools skips' },
  { file: 'tests/unit/redirect-github-tools-to-governor.test.mjs', line: 44, reason: 'B4-followup: pre-existing redirect-github-tools skips' },
  { file: 'tests/unit/redirect-github-tools-to-governor.test.mjs', line: 51, reason: 'B4-followup: pre-existing redirect-github-tools skips' },
  { file: 'tests/unit/redirect-github-tools-to-governor.test.mjs', line: 57, reason: 'B4-followup: pre-existing redirect-github-tools skips' },
  { file: 'tests/unit/redirect-github-tools-to-governor.test.mjs', line: 63, reason: 'B4-followup: pre-existing redirect-github-tools skips' },
  { file: 'tests/unit/redirect-github-tools-to-governor.test.mjs', line: 69, reason: 'B4-followup: pre-existing redirect-github-tools skips' },
