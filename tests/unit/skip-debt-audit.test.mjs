...
//   - 27 total describe.skip / it.skip occurrences across tests/ (excluding skipIf / variable forms)
//   - 7 hotfix-introduced (Buckets A/B/C/D)
//   - 4 operational (documented A1/A2/A5 post-merge checks)
//   - 16 pre-existing (project-bootstrap=7, redirect-github-tools=6, project-registry=1, research-agent-read-git=1, init-telemetry=1)
