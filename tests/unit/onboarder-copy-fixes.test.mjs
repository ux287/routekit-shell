...
describe("onboarder Stage 4 demo copy — vertical value slice (backlog.feat.reconcile-story-sizing-po-arch-planner)", () => {
  it("affirmatively frames the demo as a VERTICAL value slice", () => {
    expect(src).toContain("VERTICAL value slice");
  });

  it("does NOT sell a horizontal stack-layer split", () => {
    expect(src).not.toContain("framework, service, and UI layers");
    expect(src).not.toContain("framework/service/UI layers");
  });
});
