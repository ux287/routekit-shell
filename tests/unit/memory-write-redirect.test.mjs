...
// Resolve the DEPLOYED copy from the live tree, falling back to .bak during off-rail sessions.
const DEPLOYED = resolveHookPath('write/redirect-edit-to-governor.mjs');
