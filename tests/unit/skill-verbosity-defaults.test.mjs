...
describe("SKILL.md verbosity defaults", () => {
  ...
  it("all 11 SKILL.md files have the verbosity field — none are missing it", () => {
  ...
  it("existing frontmatter fields are present and unchanged in all 11 SKILL.md files", () => {
    const skills = Object.keys(EXPECTED_VERBOSITY);
    for (const skill of skills) {
      const fm = readFrontmatter(skill);
