...
// Resolve the deployed hook, falling back to .routekit/hooks.bak/system/ during off-rail sessions
// (and to canonical packages/hooks/ as a last resort) so this suite runs whether guardrails are
// currently on or off.
const HOOK_PATH = resolveHookPath("system/block-git-during-off-rail.mjs", ROOT);
